...
public class ParserTest
{
    ...
    [
        ...
        new("export enum E { A }", InternalCodes.ExpectedExportableDeclaration, "Only 'fn' and 'let' declarations can be exported, got 'enum'.", null),
        new("export 123", InternalCodes.ExpectedExportableDeclaration, "Only 'fn' and 'let' declarations can be exported, got '123'.", null),
